<template>
  <div>
    <!-- 我的页面背景板 -->
    <div class="box_banner_back_box">
      <div class="box_banner_back"></div>
      <!-- 头像显示部分 -->
      <div class="box_zindex">
        <!-- 头像显示部分盒子 -->
        <div class="box_head">
          <!-- 头像 -->
          <div class="box_head_radius">
            <img
          ...
          <!-- 右侧手机号部分 -->
          <div class="box_head_mobile">157****9665</div>
          <!-- 右侧手机号部分 -->
          <!-- 去约课tag -->
          <div class="box_tag" @click="OnClick">去约课</div>
          <!-- 去约课tag -->
          <!-- 头像 -->
        </div>
        <!-- 头像显示部分盒子 -->
        <!-- 头像下方特色课部分  我的特色课一对一辅导学习币点击事件 -->
        <div class="box_footer">
          <div class="box_footer_container" @click="OnevOne">
            <p class="count">0</p>
            <p class="tese">我的特色课</p>
            <p class="test">已购课程的学习</p>
          </div>
          <!-- 一对一辅导 -->
          <div class="box_footer_container" @click="Tutoring">
            <p class="count">0</p>
            <p class="tese">一对一辅导</p>
            <p class="test">我的一对一老师</p>
          </div>
          <!-- 一对一辅导 -->
          <!-- 查看剩余学习币 -->
          <div class="box_footer_container" @click="Currency">
            <p class="count">0.00</p>
            <p class="tese">查看剩余</p>
            <p class="test">剩余学习币</p>
          </div>
          <!-- 查看剩余学习币 -->
        </div>
        <!-- 头像下方特色课部分  我的特色课一对一辅导学习币点击事件 -->
    ...
    <!-- 邀请好友注册部分 -->
    <div class="box_fellow" @click="show = true">
      <div class="box_fellow_left">
        <van-icon size="0.8rem" name="send-gift-o" />
      </div>
      <div class="box_fellow_center">
        邀请好友注册APP,享多重好礼<br />
        限时特惠,多邀多得
      </div>
      <div class="box_fellow_right">
    ...
    <div>
      <p class="font">课程相关</p>
      <van-grid>
        <van-grid-item text="关注的老师" @click="$router.push('/Teacher')">
          <template #icon>
            <img
              class="tem_image"
    ...
    <div>
      <p class="font">订单相关</p>
      <van-grid>
        <van-grid-item text="课程订单" @click="$router.push('/Course')">
          <template #icon>
            <img
              class="tem_image"
        ...
        <van-grid-item text="会员订单" @click="$router.push('/Vip')">
          <template #icon>
            <img
              class="tem_image"
              src="data:image/png;base64,"
        ...
        <van-grid-item text="约课订单" @click="$router.push('/Order')">
          <template #icon>
            <img
              class="tem_image"
              src="data:image/png;base64,"
    ...
    <div>
      <p class="font">我的账户</p>
      <van-grid>
        <van-grid-item text="优惠劵" @click="$router.push('/Preferential')">
          <template #icon>
            <img
              class="tem_image"
        ...
        <van-grid-item text="学习卡" @click="$router.push('/Study')">
          <template #icon>
            <img
              class="tem_image"
        ...
        <van-grid-item text="会员" @click="$router.push('/Vips')">
          <template #icon>
            <img
              class="tem_image"
    ...
    <div>
      <p class="font">自助服务</p>
      <van-grid>
        <van-grid-item text="我的消息" @click="$router.push('/MyEmail')">
          <template #icon>
            <img
              class="tem_image"
        ...
        <van-grid-item text="意见反馈" @click="$router.push('/Feedback')">
          <template #icon>
            <img
              class="tem_image"
        ...
        <van-grid-item text="在线客服" @click="$router.push('/Service')">
          <template #icon>
            <img
              class="tem_image"
        ...
        <van-grid-item text="设置" @click="$router.push('/Intercalate')">
          <template #icon>
            <img
              class="tem_image"
...
export default {
  ...
  methods: {
    //我的特色课
    OnevOne() {
      // console.log('跳转到我的学习页面');
      this.$router.push("/UserLearn");
    },
    //我的特色课
    //   约课
    OnClick() {
